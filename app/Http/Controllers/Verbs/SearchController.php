...
class SearchController extends Controller
{
    ...
    public function paradigmResults(Request $request)
    {
        ...
        return view('verbs.search.results.paradigm', compact('data', 'rows', 'showMorphology', 'hasMorphemes', 'search', 'params', 'sources'));
    }
    ...
    public function formResults(Request $request)
    {
        ...
        return view('verbs.search.results.form', compact('results', 'languages', 'structures', 'params'));
    }
